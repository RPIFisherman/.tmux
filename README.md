...
```
curl -fsSL "https://github.com/RPIFisherman/.tmux/raw/refs/heads/master/install.sh#$(date +%s)" | bash
```

**Manual installation in `~`**
```
$ cd
$ git clone --single-branch https://github.com/RPIFisherman/.tmux.git
...
```
$ git clone --single-branch https://github.com/RPIFisherman/.tmux.git "/path/to/oh-my-tmux"
